...
public class DataBodyEntityTests {
    ...
    public void checkTwoDataBodiesAreEqualAsExpected() {
        ...
        dataHeaderEntity1.setCreatedTimestamp(currentDateTime);
        ...
        dataHeaderEntity2.setCreatedTimestamp(currentDateTime);
        DataBodyEntity dataBodyEntity2 = createTestDataBodyEntity(dataHeaderEntity2);

        assertThat(dataBodyEntity1.getChecksum()).isEqualTo(dataBodyEntity2.getChecksum());
    }
}
