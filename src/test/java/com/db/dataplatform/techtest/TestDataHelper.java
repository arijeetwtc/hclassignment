...
public class TestDataHelper {
    ...
    public static final String DUMMY_CHECKSUM = "cecfd3953783df706878aaec2c22aa70";
    ...
    public static DataBodyEntity createTestDataBodyEntity(DataHeaderEntity dataHeaderEntity) {
        ...
        dataBodyEntity.setChecksum(DUMMY_CHECKSUM);
    ...
    public static DataEnvelope createTestDataEnvelopeApiObject() {
        ...
        DataEnvelope dataEnvelope = new DataEnvelope(dataHeader, dataBody,DUMMY_CHECKSUM);
        return dataEnvelope;
    }
